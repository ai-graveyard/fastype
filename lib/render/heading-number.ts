...
function placeHeadingNumber(
  ...
  if (position === "behind") {
    heading.setAttribute(
      "style",
      `${heading.getAttribute("style") ?? ""}; position: relative; isolation: isolate`,
    );
    group.setAttribute(
      "style",
      `${group.getAttribute("style") ?? ""}; position: absolute; left: 0; top: 50%; transform: translateY(-50%); z-index: -1`,
    );
  ...
  if (position === "top") {
    group.setAttribute(
      "style",
      `${group.getAttribute("style") ?? ""}; display: flex; width: fit-content; margin: 0 0 6px`,
    );
    heading.insertBefore(group, heading.firstChild);
    return;
  }
  if (position === "bottom") {
    group.setAttribute(
      "style",
      `${group.getAttribute("style") ?? ""}; display: flex; width: fit-content; margin: 6px 0 0`,
    );
