...
export const en: Translation = {
  ...
  editor: {
    ...
    copyEmpty: "Nothing to copy — the document is empty.",
    ...
    copyStyled: "Copy",
    copyStyledLabel: "Copy with formatting (paste into Word, Notion, or email)",
    copyStyledDone:
      "Copied with formatting — paste into Word, Notion or email and it keeps its layout",
    exportMenu: "Export",
    exportMenuLabel: "Export preview",
    exportHtml: "Export HTML",
    exportHtmlHint: "Single file, styles inlined",
    exportHtmlDone: "HTML downloaded",
    printPreview: "Save as PDF",
    printHint: "Choose “Save as PDF” in the print dialog",
    printFailed: "The browser refused the save-as-PDF request.",
    previewThemes: "Preview themes",
    moreThemes: "More",
    moreThemesLabel: "More themes",
    themeGitHub: "GitHub",
    themeNotion: "Notion",
    themePaper: "Paper",
    themeNight: "Night",
